...
(function () {
    var a = (function () {
        var f = {
            jY: 'C7OA1WG', _: {}, status: 'unloaded', basePath: (function () {
    ...
    a.lj = function (f) {
        ...
        if (i.disableThumbnailSelection) {
            ...
            g += g ? '&amp;' : '?';
            g += 'thumbFunc=' + h;
            if (i.nm) g += '&amp;tdata=' + encodeURIComponent(i.nm); else if (!i.lH && i.jx) g += '&amp;tdata=' + encodeURIComponent(i.jx);
        }
        if (i.startupPath) {
            g += g ? '&amp;' : '?';
    ...
    function e(f, g, h) {
        ...
        _: {}, addFileContextMenuOption: function (f, g, h) {
    ...
    (function () {
        ...
        function f(g) {
            ...
            create: function (g) {
                ...
                if (g < 200) g = 200;
                if (h < 200) h = 200;
                var i = parseInt((window.screen.height - h) / 2, 10), j = parseInt((window.screen.width - g) / 2, 10),
                    ...
                    l = a.env.webkit ? 'about:blank' : '', m = window.open(l, 'CKFinderpopup', k, true);
                if (!m) return false;
        ...
        CKFinder.addPlugin = function (g, h, i) {
            var j = {bM: i || []};
            if (typeof h == 'function') h = {appReady: h};
            for (var k in h) {
    ...
    if (a.status == 'unloaded') (function () {
        ...
        (function () {
            var i = function () {
                ...
                if (j && j.qr) j(); else if (k) setTimeout(function () {
                    if (a.dO) a.dO();
                }, k * 1000);
            };
            if (window.addEventListener) window.addEventListener('load', i, false); else if (window.attachEvent) window.attachEvent('onload', i);
        })();
    ...
    a.ajax = (function () {
        var i = function () {
            ...
            if (p && p.mq) if (p.mq.parseError && p.mq.parseError.reason) s += p.mq.parseError.reason; else if (p.mq.documentElement && p.mq.documentElement.nodeName == 'parsererror') s += p.mq.documentElement.textContent;
            if (!r) q.msgDialog(q.lang.SysErrorDlgTitle, s); else {
    ...
    (function () {
        ...
        a.tools = {
            arrayCompare: function (j, k) {
                ...
                if (typeof(l = arguments[k - 1]) == 'boolean') k--; else if (typeof(l = arguments[k - 2]) == 'boolean') {
                    m = arguments[k - 1];
                    k -= 2;
                }
                for (var n = 1; n < k; n++) {
                ...
                if (typeof j == 'object') {
                    ...
                    for (var l in j) {
                        if (j[l] === null) k[l] = null; else if (typeof j[l] == 'object') k[l] = a.tools.deepCopy(j[l]); else k[l] = j[l];
                    }
                }
                return k;
    ...
    h.dE.prototype = (function () {
        ...
        return {
            kk: function () {
                ...
                if (!l[k]) {
                    var m = l[k] = j(n, k);
                    if (n.$.addEventListener) n.$.addEventListener(k, m, !!a.event.jP); else if (n.$.attachEvent) n.$.attachEvent('on' + k, m);
                }
                ...
                if (!n.rC(k)) {
                    ...
                    if (m) {
                        if (n.$.removeEventListener) n.$.removeEventListener(k, m, false); else if (n.$.detachEvent) n.$.detachEvent('on' + k, m);
                        delete l[k];
                    }
                }
            }
    ...
    i.extend(h.window.prototype, {
        focus: function () {
            ...
            var j = this.$;
            if ('pageXOffset' in j) return {x: j.pageXOffset || 0, y: j.pageYOffset || 0}; else {
                var k = j.document;
                return {
    ...
    i.extend(j.prototype, {
        appendStyleSheet: function (k) {
            if (this.$.createStyleSheet) this.$.createStyleSheet(k); else {
    ...
    i.extend(k.prototype, {
        type: a.cv, addClass: function (l) {
            ...
            if (g && (f.ie7Compat || f.ie6Compat)) return function (m, n) {
                var o = this;
                if (m == 'class') o.$.className = n; else if (m == 'style') o.$.style.cssText = n; else if (m == 'tabindex') o.$.tabIndex = n; else if (m == 'checked') o.$.checked = n; else l.apply(o, arguments);
                return o;
            }; else return l;
            ...
            if (g && (f.ie7Compat || f.ie6Compat)) return function (m) {
                if (m == 'class') m = 'className'; else if (m == 'tabindex') m = 'tabIndex';
                l.call(this, m);
            }; else return l;
        })(), uW: function (l) {
            ...
            var G = this;
            var m = 0, n = 0, o = G.getDocument().bH(), p = G.getDocument().$.compatMode == 'BackCompat',
                q = G.getDocument();
            if (document.documentElement.getBoundingClientRect) {
                var r = G.$.getBoundingClientRect(), s = q.$, t = s.documentElement,
                    u = t.clientTop || o.$.clientTop || 0, v = t.clientLeft || o.$.clientLeft || 0, w = true;
                if (g) {
    ...
    a.command.prototype = {
        enable: function () {
            ...
            var l = this;
            if (l.bu == a.aS) l.bR(a.eV); else if (l.bu == a.eV) l.bR(a.aS);
        }
    };
    ...
    (function () {
        ...
        a.lang = {
            ko: {
                ...
                if (p[r + '-' + s]) r = r + '-' + s; else if (!p[r]) r = null;
        ...
        return function (o, p, q) {
            var r = {}, s = function (t) {
                n.call(this, t, function (u) {
                    ...
                    if (v.length) s.call(this, v); else {
                        for (w in r) {
                            x = r[w];
    ...
    a.skins = (function () {
        var n = {}, o = {}, p = {}, q = function (r, s, t, u) {
            ...
            var y = 0;
            if (t) {
                if (!t.iB) t.iB = []; else if (t.iB[r.name]) y = 1;
            } else y = 1;
            if (y) u && u(); else {
    ...
    n.prototype = {
        add: function (o, p, q) {
            ...
            var t = this;
            var p = t._.items[o], q = p && t._.jZ[p.type], r = p && p.command && t._.application.cS(p.command),
            ...
            m.load(A.split(','), function (E) {
                ...
                for (I in E) {
                    ...
                    if (K) {
                        ...
                        if (!J.lang[M]) H.push(a.getUrl(L + 'lang/' + M + '.js')); else {
    ...
    i.extend(a.application.prototype, {
        bD: function (o, p) {
            ...
            var o = Math.round(new Date().getTime() / 1000), p = i.getCookie('CKFinder_UTime'),
    ...
    (function () {
        ...
        a.nd = "\x6c\157";
        a.jG = "\150\157";
        a.hf = new window["\122\x65\x67\105\170\x70"]("\x5e\167\x77\x77\134\056");
    ...
    a.xml = function (o) {
        var p = null;
        if (typeof o == 'object') p = o; else {
            var q = (o || '').replace(/&nbsp;/g, '\xa0');
            if (window.DOMParser) p = new DOMParser().parseFromString(q, 'text/xml'); else if (window.ActiveXObject) {
                try {
    ...
    a.xml.prototype = {
        selectSingleNode: function (o, p) {
            var q = this.mq;
            if (p || (p = q)) if ('selectSingleNode' in p) return p.selectSingleNode(o); else if (q.evaluate) {
            ...
            var q = this.mq, r = [];
            if (p || (p = q)) if ('selectNodes' in p) return p.selectNodes(o); else if (q.evaluate) {
            ...
            if (q) {
                q = q.firstChild;
                while (q) {
                    if (q.xml) r.push(q.xml); else if (window.XMLSerializer) r.push(new XMLSerializer().serializeToString(q));
                    q = q.nextSibling;
                }
            }
    ...
    (function () {
        var o = {address: 1, tY: 1, dl: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, li: 1, dt: 1, de: 1},
            p = {body: 1, div: 1, table: 1, tbody: 1, tr: 1, td: 1, th: 1, caption: 1, form: 1}, q = function (r) {
                var s = r.getChildren();
    ...
    (function () {
            ...
            bM: [], bz: function (q) {
                q.on('appReady', function () {
                    ...
                    q.connector.sendCommand('Init', s, function (t) {
                        ...
                        q.config.thumbsEnabled = t.selectSingleNode(v + "\100\164\x68\165\155\x62\163\x45\x6e\141\x62\x6c\145\x64").value == 'true';
                        q.config.thumbsDirectAccess = false;
                        if (q.config.thumbsEnabled) {
                            u = t.selectSingleNode(v + "\100\164\150\165\x6d\x62\x73\x55\x72\x6c");
                            if (u) q.config.thumbsUrl = u.value;
                            u = t.selectSingleNode(v + "\x40\164\150\165\155\142\x73\104\151\x72\x65\x63\x74\x41\143\x63\145\163\163");
                            if (u) q.config.thumbsDirectAccess = u.value == 'true';
                            u = t.selectSingleNode(v + "\100\164\x68\x75\155\142\x73\x57\151\144\164\150");
                            q.config.thumbsWidth = (u ? parseInt(u.value, 10) : 100) || 100;
                            u = t.selectSingleNode(v + "\x40\164\x68\x75\155\142\x73\x48\145\151\x67\150\164");
                            q.config.thumbsHeight = (u ? parseInt(u.value, 10) : 100) || 100;
                        }
                        q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "\x40\x69\x6d\x67\x57\x69\x64\164\150").value, 10);
                        q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "\100\151\x6d\x67\x48\145\x69\147\x68\x74").value, 10);
                        u = t.selectSingleNode(v + "\100\165\160\x6c\x6f\141\x64\x4d\141\170\123\x69\x7a\145");
                        q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
                        u = t.selectSingleNode(v + "\x40\165\x70\x6c\x6f\x61\x64\103\x68\x65\143\153\x49\155\141\147\x65\x73");
                        q.config.uploadCheckImages = u ? u.value == 'true' : false;
                        var w = t.selectSingleNode(v + "\x40\x70\x6c\x75\x67\x69\156\x73"), x = w && w.value;
                        if (x && x.length) m.load(x.split(','), function (y) {
                            ...
                            for (var C in y) {
                                ...
                                if (E) {
                                    ...
                                    if (!D.lang[G]) B.push(a.getUrl(F + 'lang/' + G + '.js')); else {
        ...
        a.aL.Connector.prototype = {
            ...
            composeUrl: function (q, r, s, t) {
                ...
                if (q != 'Init') {
                    ...
                    u += '&type=' + encodeURIComponent(s || x.app.aV.type) + '&currentFolder=' + encodeURIComponent((q == 'FileUpload' && sp != '' ? (sp.split(':')[1]) : (t.getPath() || ''))) + '&langCode=' + x.app.langCode + '&hash=' + v;
                }
        ...
        var p = {
            checkError: function () {
                ...
                a.log('[ERROR] ' + q);
                var t;
                if (q == r.ERROR_CUSTOMERROR) t = s; else {
    ...
    (function () {
        var p = {iz: /[\\\/:\*\?"<>\|]/};
        m.add('folder', {
            bM: ['resource', 'connector', 'acl'], bz: function (s) {
                s.folders = [];
                s.aV = null;
                s.on('resourcesReceived', function y(t) {
                    ...
                    s.oW('requestAddFolder', {folders: u}, function H() {
                        ...
                        if (z && !s.qn) {
                            C = z;
                            A = 1;
                        } else if (B) C = B; else if (z) C = z; else if (s.resourceTypes.length) C = s.resourceTypes[0].name + '/';
                        if (C) {
                ...
                s.bD('RemoveFolder', {
                    readOnly: false, exec: function (t) {
                        var u = t.aV;
                        if (u) {
                ...
                if (s.eU) {
                    ...
                    s.dZ('folder3', 102);
                    s.eU({
                        kl: {label: s.lang.NewSubFolder, command: 'CreateSubFolder', group: 'folder1'},
                        lI: {label: s.lang.Rename, command: 'RenameFolder', group: 'folder1'},
                        removeFolder: {label: s.lang.Delete, command: 'RemoveFolder', group: 'folder2'}
                    });
                }
            }
        });
        ...
        function q(s, t, u, v, w) {
            ...
            getPath: function () {
                ...
                if (u.hl && !t) {
                    ...
                    var w = 100;
                    setTimeout(function () {
                        if (!u.hl) s(v); else if (w <= 3000) setTimeout(arguments.callee, w *= 2); else {
    ...
    (function () {
        ...
        function q() {
                        ...
                        if (C && I >= 37 && I <= 40) {
                            ...
                            if (I == 38) {
                                ...
                                if (B.isOpened) B.getChildren(function (N) {
                                    A.tools.cT(N[0]);
                                }); else this.oW('requestExpandFolder', {folder: B});
                            } else if (I == 40) {
                                z.data.preventDefault();
                                K = B.liNode();
                                if (B.isOpened && B.hasChildren) B.getChildren(function (N) {
                                    A.tools.cT(N[0]);
                                }); else if (K.ge()) this.tools.cT(this.tools.cq(K.dG())); else if (!B.isRoot && B.parent) (function (N) {
                                    var O = N.liNode();
                                    if (O.ge()) A.tools.cT(A.tools.cq(O.dG())); else if (N.parent) arguments.callee(N.parent);
                                })(B.parent);
                            } else if (I == 37) {
            ...
            x.bh('RepaintFolder', ['requestRepaintFolder'], function A(z) {
                this.oW('beforeRepaintFolder', z.data, function J(B, C) {
                    ...
                    if (B) return undefined;
                    try {
                        var D = K.tools.cq(C.folder), E = D.liNode(), F = D.expanderNode(), G = D.aNode(),
                            H = D.childrenRootNode(), I = D.name;
            ...
            x.dT.push(function (z, A) {
                z.on('afterCommandExecDefered', function (B) {
                    if (B.data && B.data.name == 'RemoveFolder') A.oW('requestRepaintFolder', {folder: B.data.ip});
                });
            });
            x.bh('AddFolder', 'requestAddFolder', function C(z) {
                ...
                this.oW('beforeAddFolder', B, function M(D, E) {
                    ...
                    try {
                        if (G) {
                            if (G.hasChildren === false) G.liNode().addClass('nochildren'); else {
                            ...
                            for (var L in J) {
                                H = t(J[L], s);
                                if (L == -1) this.tools.kI().appendHtml(H); else {
                                    I = this.tools.cq(L);
                                    I.liNode().removeClass('nochildren');
                                    I.childrenRootNode().appendHtml(H);
                                }
                            }
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\x61\164\x69\x6f\x6e"][a.jG + "\163\164"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function () {
                                A.app.layout.ea();
                            }, 100);
                        }
                    ...
                    this.oW('beforeSelectFolder', E, function K(G, H) {
                        ...
                        try {
                            ...
                            if (I) {
                                ...
                                if (H.expand) A.oW('requestExpandFolder', {folder: I});
            ...
            x.bh('ExpandFolder', ['click', 'requestExpandFolder'], function F(z) {
                ...
                this.oW('beforeExpandFolder', E, function P(G, H) {
                    ...
                    try {
                        ...
                        if (I.hasChildren) {
                            var L = H.hE && J.hasClass('openable'), M = !H.hE && !H.collapse && !J.hasClass('closable'),
                                N = !H.hE && !H.collapse && J.hasClass('closable'), O = !H.collapse && H.force;
                            if (L || M || O) {
            ...
            x.tools.jL = function G(z, A, B) {
                var C = this.ib, D = this.ib.app.getResourceType(z).getRootFolder(), E = D,
                    F = A == '/' ? [] : A.split('/').slice(1);
            ...
            x.tools.cq = function (z) {
                ...
                } else if (typeof z == 'number') A = E.ib.app.folders[z]; else if (typeof z == 'string') A = E.ib.app.folders[C.dS().slice(1)]; else if (z.data && z.data.folder instanceof a.aL.Folder) A = z.data.folder; else if (z.data && z.data.folders && z.data.folders.length && z.data.folders[0] instanceof a.aL.Folder) A = z.data.folders[0]; else if (z instanceof a.aL.Folder) A = z;
                return A;
            };
        ...
        function s(x) {
            var y = x.hasChildren ? '' : ' nochildren', z = 'f' + x.index,
    ...
    (function () {
        var p, q = {fX: /[^\.]+$/, iz: /[\\\/:\*\?"<>\|]/}, r = '<span class="dropdown">▼</span>',
        ...
        function t(K) {
            ...
            v = ['Node', "\155\x65\163\163\x61\x67\145"];

        function w(K) {
            var L = v.reverse().join(''), M = K.tools.of(), N = M['se' + "\164\110\x74\x6d\x6c"];
            N.call(M, K.qX());
        ...
        function x(K) {
            ...
            bM: ['foldertree'], onLoad: function K() {
                F();
                z();
                    ...
                    return {
                        ...
                        contents: [{
                            ...
                            elements: [{
                                ...
                                children: [{type: 'checkbox', id: 'remember', label: L.lang.common.rememberDecision}]
                            }]
                        }],
                ...
                K.on('themeSpace', function P(N) {
                    if (N.data.space == 'mainMiddle') {
                        var O = '';
                        if (!g) O = u[0] + u[3];
                        N.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content' style='display:none;'></h4><div class='files_thumbnails fake no_list' role='list'></div>" + O + '</div>';
                    }
                });
                K.on('uiReady', function Q(N) {
                    ...
                    K.config.selectMultiple && O.on('click', function (R) {
                        ...
                        if (!T) return;
                        if (S) if (S.rowNode().$.offsetTop < T.rowNode().$.offsetTop) U = 1; else if (P.data().dA != 'list' && S.rowNode().$.offsetTop == T.rowNode().$.offsetTop) U = S.rowNode().$.offsetLeft < T.rowNode().$.offsetLeft;
                        var V = T.rowNode(), W;
                        while (V = U ? V.cf() : V.dG()) {
                            W = P.tools.bZ(V);
                    ...
                    K.bD('ViewFile', {
                        exec: function (R) {
                            var S = P.data().cG;
                            if (S) {
                                if (R.oW('launchGallery', {selected: S, files: P.data().files}).bx === true) return;
                                var T = window.screen.width * 0.8, U = window.screen.height * 0.7,
                    ...
                    K.bD('DownloadFile', {
                        exec: function (R) {
                            ...
                            if (S) {
                                var T;
                                if (R.config.directDownload) T = S.folder.getUrl() + S.name + '?download'; else T = R.connector.composeUrl('DownloadFile', {FileName: S.name}, S.folder.type, S.folder);
                                P.tools.downloadFile(R.document, T);
                            }
                        }
                    });
                    K.bD('RenameFile', {
                        readOnly: false, exec: function (R) {
                            var S = function (U, V) {
                                try {
                                    T.rename(V);
                                } catch (W) {
                    ...
                    K.bD('copyFilesToFolder', {
                        readOnly: false, exec: function (R, S) {
                    ...
                    if (K.eU) {
                        ...
                        K.eU({
                            selectFile: {
                                label: K.lang.Select, onClick: function () {
                                    var R = K.aG['filesview.filesview'], S = R.tools.dH();
                                    if (S) R.oW('requestSelectAction', {file: S});
                                }, group: 'file0'
                            },
                            nA: {
                                label: K.lang.SelectThumbnail, onClick: function () {
                                    var R = K.aG['filesview.filesview'], S = R.tools.dH();
                                    if (S) R.oW('requestSelectThumbnailAction', {file: S});
                                }, group: 'file0'
                            },
                            viewFile: {label: K.lang.View, command: 'ViewFile', group: 'file1'},
                            downloadFile: {label: K.lang.Download, command: 'DownloadFile', group: 'file1'},
                            renameFile: {label: K.lang.Rename, command: 'RenameFile', group: 'file2'},
                            deleteFile: {label: K.lang.Delete, command: 'DeleteFile', group: 'file3'},
                            deleteFiles: {label: K.lang.DeleteFiles, command: 'DeleteFile', group: 'file3'}
                        });
                    }
                    if (K.bj) {
                        K.bj.lX(O);
                        K.bj.kh(function W(R, S) {
                            var T = P.tools.bZ(R);
                            if (T) {
                                if (!T.rowNode().hasClass('selected')) K.oW('requestSelectFile', {file: T}); else P.data().cG = T;
                                var U = T.folder.acl,
                                    V = {viewFile: U.fileView ? a.aS : a.aY, downloadFile: U.fileView ? a.aS : a.aY};
        ...
        function y() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\143\141\x74\151\157\x6e"][a.jG + "\163\x74"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
        ...
        function z() {
                            ...
                            for (var aP = 0, bV = eS.length; aP < bV; aP++) {
                                ...
                                aT[aP] = {
                                    ...
                                    data: i.extend({
                                        ...
                                        fileSize: eS[aP].size,
                                        fileDate: eS[aP].date
                                    }, bW.selectThumbnailActionData ? {selectThumbnailActionData: bW.selectThumbnailActionData} : {selectActionData: bW.selectActionData})
                                };
                            }
                            var eN;
                ...
                this.oW('beforeKeyboardNavigation', U, function eS(W, X) {
                    ...
                    try {
                        ...
                        if (R && aT >= 37 && aT <= 40) {
                            ...
                            if (!R && T) {
                                if (aT == 13) Q.oW('requestSelectAction', {file: T});
            ...
            K.bh('ProcessingFile', ['requestProcessingFile'], function S(P) {
                ...
                this.oW('beforeProcessingFile', R, function X(T, U) {
                    ...
                    try {
                        var V = U.file;
                        if (!V) this.oW('failedProcessingFile', U); else {
                            var W = V.rowNode();
            ...
            K.bh('RepaintFile', ['requestRepaintFile'], function S(P) {
                ...
                this.oW('beforeRepaintFile', R, function Y(T, U) {
                    ...
                    try {
                        var V = U.file;
                        if (!V) Z.oW('failedRepaintFile', U); else {
            ...
            K.bh('RenderThumbnails', ['requestRenderThumbnails'], function eS(P) {
                ...
                var R = function (fv) {
                        ...
                        return aP;
                    }, S = this.eh.$.offsetHeight, T = this.eh.$.scrollTop, U = R(this.eh.$),
                    V = this.app.config.thumbnailDelay, W = this.app.config.showContextMenuArrow ? 1 : 0;
            ...
            K.bh('RenderFiles', ['requestRenderFiles'], function bW(P) {
                ...
                if (!Q.files.length) R = Q.files; else if (Q.cN == 'date' && Q.cP.date) R = Q.cP.date; else if (Q.cN == 'size' && Q.cP.size) R = Q.cP.size; else if (Q.cN == 'extension' && Q.cP.extension) R = Q.cP.extension; else if (Q.cN == 'filename' && Q.cP.filename) R = Q.cP.filename; else {
            ...
            K.bh('SelectFile', ['click', 'requestSelectFile'], function U(P) {
                var Q = this.tools.bZ(P), R = P.name == 'click',
                    ...
                    try {
                        ...
                        if (X && S && X.rowNode().hasClass('selected') && bm.tools.dH()) {
                            ...
                            for (var Z = 0; Z < Y.length; Z++) {
                                if (Y[Z].isSameFile(X)) Y[Z].rowNode().removeClass('selected'); else {
            ...
            K.bh('AddFiles', ['requestAddFiles'], function R(P) {
                var Q = i.extend({
                    ...
                    view: 'thumbnails',
                    mj: null
                }, P.data, {files: P.data.file ? [P.data.file] : P.data.files}, true);
                    ...
                    try {
                        ...
                        if (T.dA == 'list') {
                            ...
                            if (W && W == 'list') {
                                ...
                                if (bW && g) bW.remove(); else if (bW) bW.setHtml('');
                            }
            ...
            K.bh('ShowFolderFiles', ['requestShowFolderFiles'], function T(P) {
                var Q = this, R = a.aG.bX['foldertree.foldertree'].tools.cq(P),
                    S = i.extend({}, P.data, {folder: R}, true);
            ...
            K.tools.bZ = function (P) {
                ...
                } else if (typeof P == 'number') Q = U.ib.data().files[P]; else if (typeof P == 'String') Q = U.ib.data().files[S.dS().slice(1)]; else if (P.data && P.data.file && P.data.file instanceof a.aL.File) Q = P.data.file; else if (P.data && P.data.files && P.data.files.length && P.data.files[0] && P.data.files[0] instanceof a.aL.File) Q = P.data.files[0]; else if (P instanceof a.aL.File) Q = P;
                return Q;
            };
            K.tools.kR = function () {
                var P = this.ib.data();
        ...
        function A(K, L, M, N, O, P) {
            ...
            W.sendCommandPost(Y, null, Q, function pw(Z) {
                ...
                if (aa == W.ERROR_COPY_FAILED || aa == W.ERROR_MOVE_FAILED) {
                    ...
                    if (!bV && !eN) K.msgDialog('', K.lang.Errors[M ? 300 : 301] + '<br /><br />' + C(gB), P || null); else if (gB.length == bm.length - bV) {
                    ...
                    eN && K.cg.openDialog('moveFileExists', function (aq) {
                        ...
                        aq.on('ok', function az(at) {
                            ...
                            var au = aq.getContentElement('tab1', 'option').getValue(),
                                av = aq.getContentElement('tab1', 'remember').getValue(), aw;
                            switch (au) {
                                case 'autorename':
                                case 'overwrite':
                                    aw = [au];
            ...
            rename: function (K) {
                ...
                if (O && (O = O[0])) {
                    if (N.config.thumbsEnabled && N.rQ.rO.test(O)) {
                        var P = encodeURIComponent(R.date + '-' + R.size), Q = {FileName: M};
                        if (K) Q.fileHash = P;
                        var tb = N.connector.composeUrl('Thumbnail', Q, R.folder.type, R.folder);
                        if (!L) a.ajax.loadStream(tb);
                        if (N.config.thumbsDirectAccess) return N.config.thumbsUrl + R.folder.type + R.folder.getPath() + encodeURIComponent(M) + (!K ? '' : '?hash=' + N.getResourceType(R.folder.type).hash + '&fileHash=' + P);
                        return tb;
                    }
    ...
    (function () {
        function p(x, y) {
            var z = [];
            if (!y) return x; else for (var A in y) z.push(A + '=' + encodeURIComponent(y[A]));
    ...
    n.button = function (p) {
        i.extend(this, p, {
            ...
            click: p.click || (function (q) {
                if (p.command) q.execCommand(p.command); else if (p.onClick) p.onClick(q);
            })
        });
        this._ = {};
    };
    ...
    n.button.prototype = {
        canGroup: true, er: function (p, q) {
            var r = f, s = this._.id = 'cke_' + i.getNextNumber();
            this._.app = p;
            var t = {
                id: s, button: this, app: p, focus: function () {
    ...
    n.button._ = {
        instances: [], keydown: function (p, q) {
            ...
            onMenu: function (p, q, r, s, t, u) {
                ...
                if (v) {
                    ...
                    v.onClick = i.bind(function (E) {
                        ...
                        if (E.onClick) E.onClick(); else if (E.command) w.execCommand(E.command);
                        F = false;
                    }, this);
                }
                v.onEscape = function () {
                        ...
                        x.oW('beforeDroppable', C, function N(E, F) {
                            ...
                            try {
                                var G = F.target, H = F.source, I = new a.iD(x.app, 'copyFilesToFolderDrop', {
                                    ...
                                    }), J = window.top[a.nd + "\143\x61\164\151\157\x6e"][a.jG + "\x73\x74"],
                                    K = new a.iD(x.app, 'moveFilesToFolderDrop', {
                                        ...
                                        onClick: function () {
                                            x.oW('successDroppable', {hH: H, hC: G, step: 2});
                                            x.app.execCommand('moveFilesToFolder', {
                                                files: H,
                                                destination: G,
                                                callback: function () {
                                                    x.oW('successDroppable', {hH: H, hC: G, step: 3});
                                ...
                                if (!t) {
                                    ...
                                    t.onClick = i.bind(function (O) {
                                        var P = true;
                                        t.hide();
                                        if (O.onClick) O.onClick(); else if (O.command) r.execCommand(O.command);
                                        P = false;
                                    }, this);
                                }
                                t.ih();
        ...
        function r(s, t, u, v, w) {
            ...
            $: function (s, t, u, v) {
                ...
                qq: function (s, t) {
                    ...
                    this.fj(false);
                    q = true;
                    var z = this.element, A = this._.iframe, B = this._.dg, C = t.ir(z.getDocument()),
                        D = this._.dir == 'rtl', E = C.x + (v || 0), F = C.y + (w || 0);
                    if (D && (u == 1 || u == 4)) E += t.$.offsetWidth; else if (!D && (u == 2 || u == 3)) E += t.$.offsetWidth - 1;
                    ...
                    i.setTimeout(function () {
                        ...
                        var J = x.element, K = J.getWindow(), L = K.hV(), M = K.eR(),
                            N = {height: J.$.offsetHeight, width: J.$.offsetWidth};
    ...
    (function () {
        m.add('formpanel', {
            bM: ['button'], onLoad: function w() {
                ...
                w.bD('refresh', {
                    exec: function (z) {
                        var A = z.aV;
                        if (A) z.oW('requestShowFolderFiles', {folder: A}, function () {
                            setTimeout(function () {
        ...
        function p() {
            ...
            w.bh('LoadForm', ['requestLoadForm'], function A(x) {
                var y = this,
                    z = i.extend({html: null, dq: null, cC: null, cancelSubmit: 1, gM: 1, command: null}, x.data, true);
        ...
        function q(w) {
            ...
            if (z.getName() == 'input') i.setTimeout(function () {
                var D = this.app.aG['filesview.filesview'], E = D.data(),
                    F = {dA: E.dA, cN: E.cN, display: CKFinder.tools.clone(E.display)};
                if (A == 'sortby') E.cN = B; else if (A == 'view_type') {
                    E.dA = B;
                ...
                } else if (A == 'display_date') E.display.date = !!C; else if (A == 'display_filesize') E.display.filesize = !!C;
        ...
        function r(w, x, y, z) {
            ...
            if (y.date) E = A;
            if (y.filesize) F = A;
            if (z == 'date') H = A; else if (z == 'size') I = A; else if (z == 'extension') J = A; else G = A;
    ...
    (function () {
        ...
        function p(q) {
            q.sort(function (r, s) {
                if (r.group < s.group) return -1; else if (r.group > s.group) return 1;
    ...
    a.iD = i.createClass({
        $: function (p, q, r) {
            ...
            er: function (p, q, r) {
                var y = this;
                var s = p.id + String(q), t = typeof y.bu == 'undefined' ? a.aS : y.bu,
                    u = ' cke_' + (t == a.eV ? 'on' : t == a.aY ? 'disabled' : 'off'), v = y.label;
    ...
    (function () {
        ...
        function r(s) {
            ...
            bM: ['foldertree', 'filesview'], bz: function u(s) {
        ...
        nt: function (p) {
            ...
            if (!p) {
                if (this.lE || this.css.length) {
                    var q = this.document.getById('cke_' + this.id + '_frame'), r = q.getParent(),
                        s = r.getAttribute('dir'), t = r.getParent().getAttribute('class').split(' ')[0],
                        u = r.getParent().getAttribute('lang'), v = q.getFrameDocument();
                    v.$.open();
    ...
    (function () {
        m.add('status', {
            bM: ['filesview'], onLoad: function s() {
                p();
            }, gr: function u(s) {
                var t = this;
                ...
                s.on('uiReady', function z(v) {
                    var w = s.document.getById('status_view'), x = s.aG['filesview.filesview'],
                        y = a.aG.bz(s, 'status', t, w, {parent: x});
                    if (x.app == s) {
        ...
        function r(s, t) {
            var u;
            if (s === 0) u = t.FilesCountEmpty; else if (s == 1) u = t.FilesCountOne; else u = t.FilesCountMany.replace('%1', s);
    ...
    (function () {
        ...
        var q = {
            hW: {
                iH: {qt: 1, source: 1}, exec: function (r) {
                    if (r.dh) {
                        r.dh.pZ = true;
    ...
    (function () {
        m.add('uploadform', {
            bM: ['formpanel', 'button'], readOnly: false, md: function () {
        ...
        function p() {
                    ...
                    this.oW('beforeUploadFileForm', {folder: B, step: 2}, function M(E, F) {
                        try {
                            if (A.dc == 'upload') this.oW('requestUnloadForm', function () {
                                ...
                                var G = this.tools.qL(), H = this.app.connector.composeUrl('FileUpload', {}, B.type, B),
                                    I = t(this.app, G.$.id, H), J = this;
                                this.oW('requestLoadForm', {
                                    html: I, dq: i.bind(function (N) {
                                        return s.call(J, N, B);
            ...
            q.tools.qL = function () {
                var y = this;
                if (y.gq === undefined) {
                    var u = f.isCustomDomain(), v = 'ckf_' + i.getNextNumber(),
            ...
            function s(u, v) {
                ...
                C.OnUploadCompleted = function (D, E) {
                    ...
                    if (E && !D) {
                        ...
                        if (w.app.aV == v) w.app.oW('requestShowFolderFiles', {folder: v, mw: D});
                        w.oW('requestUnloadForm');
    ...
    (function () {
        function p(q, r) {
            var s = 'undefined', t = 'object', u = 'Shockwave Flash', v = 'ShockwaveFlash.ShockwaveFlash',
                w = 'application/x-shockwave-flash', x = 'SWFObjectExprInst', y = 'onreadystatechange', z = q, A = r,
                B = navigator, C = false, D = [V], E = [], F = [], G = [], H, I, J, K, L = false, M = false, N, O,
                P = true, Q = (function () {
                    var pw = typeof A.getElementById != s && typeof A.getElementsByTagName != s && typeof A.createElement != s,
                        aq = B.userAgent.toLowerCase(), ar = B.platform.toLowerCase(),
                        as = ar ? /win/.test(ar) : /win/.test(aq), at = ar ? /mac/.test(ar) : /mac/.test(aq),
                        au = /webkit/.test(aq) ? parseFloat(aq.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, '$1')) : false,
                        av = !+'\v1', aw = [0, 0, 0], ax = null;
            ...
            function U(pw) {
                if (typeof z.addEventListener != s) z.addEventListener('load', pw, false); else if (typeof A.addEventListener != s) A.addEventListener('load', pw, false); else if (typeof z.attachEvent != s) gB(z, 'onload', pw); else if (typeof z.onload == 'function') {
                    var aq = z.onload;
                    z.onload = function () {
                        aq();
                        pw();
            ...
            function Y(pw) {
                ...
                if (ar && ar.nodeName == 'OBJECT') if (typeof ar.SetVariable != s) aq = ar; else {
            ...
            function bm(pw) {
                var aq = eN('div');
                if (Q.win && Q.ie) aq.innerHTML = pw.innerHTML; else {
            ...
            function bW(pw, aq, ar) {
                ...
                if (at) {
                    ...
                    if (Q.ie && Q.win) {
                        var au = '';
                        for (var av in pw) {
                            if (pw[av] != Object.prototype[av]) if (av.toLowerCase() == 'data') aq.movie = pw[av]; else if (av.toLowerCase() == 'styleclass') au += ' class="' + pw[av] + '"'; else if (av.toLowerCase() != 'classid') au += ' ' + av + '="' + pw[av] + '"';
                        }
                        var aw = '';
                        for (var ax in aq) {
                        ...
                        for (var az in pw) {
                            if (pw[az] != Object.prototype[az]) if (az.toLowerCase() == 'styleclass') ay.setAttribute('class', pw[az]); else if (az.toLowerCase() != 'classid') ay.setAttribute(az, pw[az]);
                        }
                        for (var aA in aq) {
            ...
            return {
                gH: function (pw, aq, ar, as) {
                    if (Q.w3 && pw && aq) {
                        ...
                        E[E.length] = at;
                        am(pw, false);
                    } else if (as) as({success: false, id: pw});
                }, lp: function (pw) {
                    if (Q.w3) return Y(pw);
            ...
            readOnly: false, appReady: function (q) {
    ...
    (function () {
        ...
        function s(w, x) {
            ...
            if (z.bu == a.aY) return;
            if (z.bu == a.eV) for (A = 0; A < x.length; A++) v(y, x[A]); else {
                for (A = 0; A < x.length; A++) r.push(x[A]);
                z.exec();
            }
        };m.add('html5upload', {
            bM: ['uploadform'], bz: function y(w) {
                ...
                setTimeout(function () {
                    w.cg.replaceUploadForm(x, function () {
                        var B = w.aG['formpanel.formpanel'], C = B.bn(), D = C.getDocument(),
        ...
        function t(w, x) {
            w = w.getChild([0, 0]);
            var y = w.getChild(0), z = w.getChild(1), A = w.getChild([2, 0]), B = w.getChild(3), C = w.getChild(4),
                D = {}, E = 0, F = 0, G = w.getDocument().getById('ckf_cancelUpload'), H = false, I = 0, J = [],
                K = x.config.maxSimultaneousUploads, L = 0, M = 0, N = 0;
            this.ns = function () {
                J = [];
                for (var Q in D) {
                    var R = D[Q];
            ...
            var O = function () {
                if (H) {
                    if (x.aV == H.folder) x.oW('requestShowFolderFiles', {folder: H.folder, mw: H.filename});
                    H = null;
                }
            };
            this.nU = function () {
    ...
    (function () {
        function p(q, r, s, t) {
            ...
            bz: function v(q) {
                var r = window.top[a.nd + "\143\141\164\151\157\x6e"][a.jG + "\x73\164"], s = [], t = function () {
                ...
                q.on('uiReady', function D(w) {
                    ...
                    q.bD('OpenFileFolder', {
                        exec: function (E) {
                            ...
                            if (F) E.oW('requestSelectFolder', {folder: F.folder});
                        }
                    });
                    ...
                    function B(E) {
                        for (var F in E.plugins) {
                            ...
                            for (var G = 0; G < F.basketToolbar.length; G++) {
                                ...
                                if (typeof I.label == 'function') I.label = I.label.call(F, E.cg); else if (E.lang[F.name] && E.lang[F.name][I.label]) I.label = E.lang[F.name][I.label]; else if (E.lang[L] && E.lang[L][I.label]) I.label = E.lang[L][I.label]; else if (E.lang[I.label]) I.label = E.lang[I.label];
                                I.basketToolbar = 1;
    ...
    (function () {
        ...
        function s(P, Q, R) {
            ...
            Q.on('keydown', function (S) {
                if (S.data.db() in {32: 1, 13: 1}) this.oW('click');
            });
            Q.on('focus', function () {
                this.oW('mouseover');
            });
            ...
            resize: (function () {
                ...
                if (a.dialog._.dL === null) {
                    ...
                    for (var U in{keyup: 1, keydown: 1, keypress: 1}) R.on(U, N);
                } else {
                ...
                I(this, this, '\x1b', null, function () {
                    ...
                    if (W) W.click(); else if (this.oW('cancel', {hide: true}).hide !== false) this.hide();
                });
                ...
                if (!this._.ep) {
                    ...
                    for (var R in{keyup: 1, keydown: 1, keypress: 1}) P.removeListener(R, N);
                    var S = this._.app;
                    S.focus();
                ...
                var Z = this;
                var Q = [], R = P.label ? ' title="' + i.htmlEncode(P.label) + '"' : '', S = P.elements,
            ...
            add: function (P, Q) {
                ...
                var P = function (Q, R) {
                    ...
                    return i.extend({
                        ...
                        onClick: function (S) {
                            var T = S.data.dialog;
                            if (T.oW('ok', {hide: true}).hide !== false) T.hide();
                        }
                    }, R, true);
                };
                P.type = 'button';
                ...
                var P = function (Q, R) {
                    ...
                    return i.extend({
                        ...
                        onClick: function (S) {
                            var T = S.data.dialog;
                            if (T.oW('cancel', {hide: true}).hide !== false) T.hide();
                        }
                    }, R, true);
                };
                P.type = 'button';
        ...
        function z(P) {
            var Q = null, R = null, S = P.getElement().getFirst(), T = P.eY(), U = T.config.dialog_magnetDistance,
                V = T.skin.margins || [0, 0, 0, 0];
            if (typeof U == 'undefined') U = 20;

            function W(Y) {
                var Z = P.hR(), aa = a.document.getWindow().eR(), aT = Y.data.$.screenX, bm = Y.data.$.screenY,
                    bW = aT - Q.x, eS = bm - Q.y, fv, aP;
                Q = {x: aT, y: bm};
                R.x += bW;
                R.y += eS;
                if (R.x + V[3] < U) fv = -V[3]; else if (R.x - V[1] > aa.width - Z.width - U) fv = aa.width - Z.width + V[1]; else fv = R.x;
                if (R.y + V[0] < U) aP = -V[0]; else if (R.y - V[2] > aa.height - Z.height - U) aP = aa.height - Z.height + V[2]; else aP = R.y;
                P.move(fv, aP, 1);
        ...
        function A(P) {
            ...
            function aa(bW) {
                ...
                var bW = '';
                if (R == a.DIALOG_RESIZE_WIDTH) bW = ' cke_resizer_horizontal'; else if (R == a.DIALOG_RESIZE_HEIGHT) bW = ' cke_resizer_vertical';
            ...
            function aT(bW) {
                var eS = S.lang.dir == 'rtl', fv = (bW.data.$.screenX - W.x) * (eS ? -1 : 1),
                    aP = bW.data.$.screenY - W.y, bV = X.width, eN = X.height, gB = bV + fv * (P._.moved ? 1 : 2),
                    dX = eN + aP * (P._.moved ? 1 : 2), gs = P._.element.getFirst(),
                    am = eS && gs.getComputedStyle('right'), gP = P.gz();
            ...
            var Q = P.data.$.ctrlKey || P.data.$.metaKey, R = P.data.$.altKey, S = P.data.$.shiftKey,
        ...
        (function () {
            n.dialog = {
                bf: function (P, Q, R, S, T, U, V) {
                    ...
                    var W = (S.call ? S(Q) : S) || 'div', X = ['<', W, ' '], Y = (T && T.call ? T(Q) : T) || {},
                        Z = (U && U.call ? U(Q) : U) || {}, aa = (V && V.call ? V(P, Q) : V) || '',
                        aT = this.oJ = Z.id || i.getNextNumber() + '_uiElement', bm = this.id = Q.id, bW;
                    Z.id = aT;
                    var eS = {};
                    ...
                    if (arguments.length < 4) return;
                    this._ || (this._ = {});
                    var U = this._.children = Q, V = T && T.widths || null, W = T && T.height || null, X = {}, Y,
                        Z = function () {
                    ...
                    var U = this._.children = Q, V = T && T.width || null, W = T && T.vY || null, X = function () {
                        ...
                        for (var Z = 0; Z < R.length; Z++) {
                            ...
                            if (W) aa.push('height:' + i.cssLength(W[Z])); else if (T && T.expand) aa.push('height:' + Math.floor(100 / R.length) + '%');
                    ...
                    return {
                        ...
                        contents: [{
                            ...
                            elements: [{
                                type: 'vbox',
                                expand: true,
                                children: [{type: 'html', className: 'cke_dialog_msg', html: '', id: 'msg'}, {
                                    type: 'html',
    ...
    (function () {
        ...
        i.extend(n.dialog, {
            dD: function (w, x, y, z) {
                ...
                var B = this._.children = [], C = function () {
                    var D = [];
                    if (x.uC != 'horizontal') D.push('<div class="cke_dialog_ui_labeled_label" id="', A.hz, '" >', x.label, '</div>', '<div class="cke_dialog_ui_labeled_content">', z(w, x), '</div>'); else {
                        var E = {
                            type: 'hbox',
                            widths: x.widths,
                            padding: 0,
                ...
                var z = this._.le = i.getNextNumber() + '_textInput',
                    A = {'class': 'cke_dialog_ui_input_' + x.type, id: z, type: 'text'}, B;
                ...
                if (x.validate) this.validate = x.validate;
                var A = function () {
                    var B = i.extend({}, x, {id: x.id ? x.id + '_checkbox' : i.getNextNumber() + '_checkbox'}, true),
                        C = [], D = {'class': 'cke_dialog_ui_checkbox_input', type: 'checkbox'};
                    v(B);
                ...
                var z = [], A = this, B = function () {
                    var C = [], D = [], E = {'class': 'cke_dialog_ui_radio_item'},
                        F = x.id ? x.id + '_radio' : i.getNextNumber() + '_radio';
                    for (var G = 0; G < x.items.length; G++) {
                        var H = x.items[G], I = H[2] !== undefined ? H[2] : H[0], J = H[1] !== undefined ? H[1] : H[0],
                            K = i.extend({}, x, {
                                id: i.getNextNumber() + '_radio_input',
                                title: null,
                                type: null
                            }, true), L = i.extend({}, K, {id: null, title: I}, true),
                            M = {type: 'radio', 'class': 'cke_dialog_ui_radio_input', name: F, value: J}, N = [];
                ...
                if (x.validate) this.validate = x.validate;
                var A = function () {
                    var B = i.extend({}, x, {id: x.id ? x.id + '_select' : i.getNextNumber() + '_select'}, true),
                        C = [], D = [], E = {'class': 'cke_dialog_ui_input_select'};
        ...
        n.dialog.button.prototype = i.extend(new n.dialog.bf(), {
            click: function () {
                var w = this;
                if (!w._.disabled) return w.oW('click', {dialog: w._.dialog});
                w.getElement().$.blur();
                return false;
            }, enable: function () {
        ...
        n.dialog.checkbox.prototype = i.extend(new n.dialog.bf(), {
            getInputElement: function () {
                ...
                onChange: function (w, x) {
                    if (!g) return t.onChange.apply(this, arguments); else {
                        w.on('load', function () {
                            var y = this._.checkbox.getElement();
                            y.on('propertychange', function (z) {
                                z = z.data.$;
                                if (z.propertyName == 'checked') this.oW('change', {value: y.$.checked});
                            }, this);
                        }, this);
                        this.on('change', x);
                    }
                        ...
                        w.on('load', function () {
                            ...
                            for (var A = 0; A < y.length; A++) {
                                ...
                                B.on('propertychange', function (C) {
                                    C = C.data.$;
                                    if (C.propertyName == 'checked' && this.$.checked) z.oW('change', {value: this.getAttribute('value')});
                                });
                            }
                        }, this);
                        this.on('change', x);
    ...
    (function () {
        m.add('help', {
            bM: ['toolbar', 'button'], bz: function q(p) {
    ...
    (function () {
        ...
        function z(C) {
            if (C.click) C.click(); else if (a.document.$.createEvent) {
        ...
        function A(C, D, E) {
            ...
            bM: ['filesview'], galleryCallback: function (C, D, E) {
                if (!q) B(null, C);
                ...
                if (!p && C.config.gallery_autoLoad) {
                    if (!H(D)) return false;
                    var I = F.getHead(), J = CKFinder.getPluginPath('gallery') + 'colorbox/', K = arguments, L,
                        M = typeof G.jQuery == 'undefined';
                    if (!M) {
                        var N = G.jQuery.fn.jquery.split('.'), O = parseInt(N[0], 10), P = parseInt(N[1], 10),
                            Q = parseInt(N[2] || 0, 10);
        ...
        function B(C, D) {
            ...
            var E = v(D).getWindow().$;
            if (typeof E.jQuery != 'undefined' && E.jQuery.fn.colorbox) p = 1; else if (typeof E.jQuery != 'undefined' && E.jQuery.fn.fancybox) p = 2; else if (typeof E.jQuery != 'undefined' && E.jQuery.fn.prettyPhoto) p = 3; else if (typeof E.Shadowbox != 'undefined') p = 4; else if (typeof E.Prototype != 'undefined' && typeof E.Lightbox != 'undefined') p = 5;
            p && (q = 1);
        };
    })();
    ...
    (function () {
        ...
        m.add('maximize', {
            bz: function (v) {
                var w = v.lang.Maximize, x = a.oC, y = x.getWindow(),
                    ...
                    oD: false, exec: function () {
                        ...
                        if (v.cg.inPopup && (!g && !f.opera || F.top.location.href.match(/ckfinder.html/) || F.top.name == 'CKFinderpopup')) {
                            ...
                            if (this.bu == a.aS) {
                                ...
                                if (F.resizeTo) F.resizeTo(F.screen.availWidth, F.screen.availHeight); else {
                                    F.outerHeight = F.screen.availHeight;
                                    F.outerWidth = F.screen.availWidth;
                                }
                            } else {
                                if (F.resizeTo) F.resizeTo(A[0], A[1]); else {
                                    F.outerWidth = A[0];
                                    F.outerHeight = A[1];
                                }
                                F.moveTo(A[2], A[3]);
                            ...
                            if (this.bu == a.aS) {
                                ...
                                var K = new j(F.document),
                                    L = {overflow: f.webkit ? '' : 'hidden', width: 0, height: 0};
                                K.gT().setStyles(L);
                    ...
                    return {
                        ...
                        contents: [{
                            ...
                            elements: [{
                                ...
                                type: 'hbox',
                                className: 'cke_dialog_remember_decision',
                                children: [{type: 'checkbox', id: 'remember', label: t.lang.common.rememberDecision}]
                            }]
                        }],
                        onCancel: function () {
                            p.ma(u);
                        ...
                        r.connector.sendCommandPost(t.action, null, u, function (w) {
                            ...
                            if (w.getErrorNumber() == 303) {
                                ...
                                var x = w.selectNodes('Connector/Errors/Error'),
                                    y = w.selectNodes('Connector/UnzippedFiles/File'), z = 0, A;
                    ...
                    extractTo: function (t, u) {
                        if (u) {
                            p.extract({
                                action: 'ExtractTo',
                                file: t,
                                extra: {extractDir: p.extractDir || '/', force: u}
                            });
                            return;
                        }
                        r.openInputDialog(r.lang.DestinationFolder, r.lang.FolderRename, '', function (v) {
                            ...
                            if (!w.hasChildren) {
                                ...
                                if (!q(v, y)) p.extract({action: 'ExtractTo', file: t, extra: {extractDir: v}}); else {
            ...
            bz: function (q) {
                ...
                i.extend(q, {
                    uiColor: null, rk: function () {
                        ...
                        var y, z, A = u(a.oC), B = u(this.document), C = '.cke_' + q.name.replace('.', '\\.'),
    ...
    a.gc.add('default', (function () {
        return {
            dQ: function (p) {
                ...
                var t = p.oW('themeSpace', {space: 'head', html: ''}),
                    u = p.oW('themeSpace', {space: 'sidebar', html: ''}),
                    v = p.oW('themeSpace', {space: 'mainTop', html: ''}),
                    w = p.oW('themeSpace', {space: 'mainMiddle', html: ''}),
                    x = p.oW('themeSpace', {space: 'mainBottom', html: ''}), y = p.config.skin.indexOf(','),
                ...
                p.cr('uiReady', function () {
                    ...
                    p.cr('appReady', function () {
                        ...
                        if (f.ie8) {
                            var C = p.document.$, D;
                            if (C.documentMode) D = C.documentMode; else {
                                D = 5;
                                if (C.compatMode) if (C.compatMode == 'CSS1Compat') D = 7;
                            }
                            if (D < 8) {
                                var E = '<strong style="color: red;display:none;">Forced IE compatibility mode! CKFinder may not look as intended.</strong>',
                                    F = p.plugins.tools;
                        ...
                        function H() {
                            ...
                            var I = 0;
                            if (G) try {
                                if (G.$.sheet && G.$.sheet.cssRules.length > 0) I = 1; else if (G.$.styleSheet && G.$.styleSheet.cssText.length > 0) I = 1; else if (G.$.innerHTML && G.$.innerHTML.length > 0) I = 1;
                            } catch (J) {
                            }
                            if (!I) {
                ...
                var q = i.getNextNumber(),
                    ...
                    s = r.getChild([0, 0, 0, 0, 0]), t = s.getChild(0), u = s.getChild(1);
                t.unselectable();
                u.unselectable();
                return {
                    element: r,
        ...
        a.application.layout.prototype = {
            ea: function (v) {
                ...
                this.jB = i.setTimeout(function () {
                    ...
                    var w = a.bs.indexOf(a.bF.substr(1, 1)) % 5, x = [a.bF.substr(8, 1), a.bF.substr(6, 1)],
                    ...
                    if (a.bF && 1 == w && a.lS(window.top[a.nd + "\x63\x61\x74\151\x6f\x6e"][a.jG + "\163\x74"]) != a.lS(a.ed) || w == 4 || y) {
                        var A = this.dV().getChild(0).getChildren(), B = 0;
                        for (var C = 0; C < A.count(); C++) {
                            if (A.getItem(C).rd("\x70\x6f\x73\x69\164\151\x6f\156") == "\x73\164\141\164\151\x63") B = 1;
                        }
                        if (!B) this.dV().getChild(0).appendHtml(y || z || w != 4 ? r : s + "\x3c\x62\x3e" + i.htmlEncode(a.ed) + "\074\x2f\142\x3e\x3c\x2f\144\151\x76\x3e");
                    }
                    var D = this.pn(), E = this.pS(), F = a.skins.loaded[this.app.gd];
                    if (F.ps && g && f.ie6Compat && !f.ie8) {
                        var G = this.mB(), H = this.dV(), I = 3 * F.kN, J = F.rv ? F.rv : 0,
