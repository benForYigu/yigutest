...
<body>
	...
	<form:form id="inputForm" modelAttribute="account" action="${ctx}/account/account/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">网易云信id：</label>
			<div class="controls">
				<form:input path="accid" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">网易云信token：</label>
			<div class="controls">
				<form:input path="token" htmlEscape="false" maxlength="128" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
