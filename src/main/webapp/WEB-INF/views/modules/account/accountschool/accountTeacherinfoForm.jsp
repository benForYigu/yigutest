...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/account/accountschool/accountTeacherinfo/">学校人员列表</a></li>
		<li class="active"><a href="${ctx}/account/accountschool/accountTeacherinfo/form?id=${accountTeacherinfo.id}">学校人员<shiro:hasPermission name="account:accountschool:accountTeacherinfo:edit">${not empty accountTeacherinfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="account:accountschool:accountTeacherinfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="accountTeacherinfo" action="${ctx}/account/accountschool/accountTeacherinfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">学校：</label>
			<div class="controls">
				<form:input path="schoolId" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="account:accountschool:accountTeacherinfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
