...
import com.thinkgem.jeesite.API.weixin.bean.user.FollowResult;
import com.thinkgem.jeesite.API.weixin.bean.user.Group;
import com.thinkgem.jeesite.API.weixin.bean.user.UserInfoList;
import com.thinkgem.jeesite.API.weixin.bean.user.WxUser;
