...
public class SnsAPI extends BaseAPI {
     ...
     * @return
     */
    public static SnsToken oauthAccessToken(String appid, String secret, String code) {
    ...
    public static boolean checkAccessToken(String accessToken, String openId) {
        HttpUriRequest httpUriRequest = RequestBuilder.post()
                ...
                .build();
        SnsToken token = LocalHttpClient.executeJsonResult(httpUriRequest, SnsToken.class);
