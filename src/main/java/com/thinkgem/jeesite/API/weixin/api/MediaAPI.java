...
import com.thinkgem.jeesite.API.weixin.bean.media.MediaType;
import com.thinkgem.jeesite.API.weixin.bean.media.UploadimgResult;
...
public class MediaAPI extends BaseAPI {
    private static Log log = LogFactory.getLog(MediaAPI.class);
...
/**
    ...
    public static byte[] mediaGet(String access_token, String media_id) {
        HttpUriRequest httpUriRequest = RequestBuilder.get()
                ...
                .build();
        log.info("URI: " + httpUriRequest.getURI().toString());
