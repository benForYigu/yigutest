...
public class AliMessageUtils {
    ...
    static String accessKeyId = "LTAIjL5rdzu48CMR";
    static String accessKeySecret = "V5XSF9cR1KkLDNzCMcjzg5pqcODBvd";

    public static String PHONE_BIND = "SMS_160425055";//您本次验证码为：${code}，该验证码5分钟内有效，请勿泄露于他人。大匡学院，为理财师而生。
    ...
    public static void main(String[] args) throws InterruptedException, ClientException {
         ...
         //发短信
        //SMS_128880608
        String phoneNumber = "18373712829";
        String templateCode = PHONE_BIND;



        SendSmsResponse response = sendSms(phoneNumber,templateCode,"153455");
    ...
    public static SendSmsResponse sendSms(String phoneNumber,String templateCode,
                                          Map<String,String> map) throws ClientException {
